"""
Django settings for bay_lake_winery project.
...
print("SECRET_KEY from environment:", os.environ.get('SECRET_KEY'))
...
# often not needed so check if needed before submission
...
WSGI_APPLICATION = 'bay_lake_winery.wsgi.application'
