...
- HTML
  - No errors were returned when passing through the official[W3C validator](https://validator.w3.org/xxxxxxxx)
...
- CSS
  - No errors were found when passing through the official [(Jigsaw) validator](https://jigsaw.w3.org/css-xxxxxxxxx)
- JavaScript
...
- When a user comes to the start page they are welcomed by images and text explaining the site's purpose.

![hero image](assets/images/hero.png)

*As a User I can navigate around the site so that I can easily view what products are offered.*

- The navigation bar on the top of every page with the current page's link darkened.

![nav-bar](assets/images/navbar.png)

*As a User I can view a
